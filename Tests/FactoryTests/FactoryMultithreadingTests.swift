...
fileprivate final class MultiThreadedContainer: SharedContainer {
    ...
    fileprivate var a: Factory<A> { unique { A(b: self.b()) } }
    fileprivate var b: Factory<B> { unique { B(c: self.c()) } }
    fileprivate var c: Factory<C> { unique { C(d: self.d()) } }
    fileprivate var d: Factory<D> { cached { D() } }
    fileprivate var e: Factory<E> { unique { E() } }
