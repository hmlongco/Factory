...
//public struct Factory<T>: BaseFactory {
//    public init(_ container: SharedContainer, key: Int = #line, _ factory: @escaping () -> T) {
//        registration = Registration(container, scope: nil, key: key, factory)
//    }
//    internal let registration: Registration<T>
//
//
//    //    /// New initializer
//    //    public init(_ container: SharedContainer, scope: Scope? = .unique, key: Int = #line, _ factory: @escaping () -> T) {
//    //        self.id = "\(container.manager.managerID).\(T.self).\(key)"
...
//    associatedtype T
//    var registration: Registration<T> { get }
//}
//
//extension BaseFactory {
//    public func callAsFunction() -> T {
//        registration.container.manager.resolve(registration)
//    }
//    public func register(factory: @escaping () -> T) {
//        registration.container.manager.register(id: registration.id, factory: factory)
//    }
//    public func reset(_ options: FactoryResetOptions = .all) {
...
//}
//
//struct Shared<T>: BaseFactory {
//    public init(_ container: SharedContainer, key: Int = #line, _ factory: @escaping () -> T) {
//        registration = Registration(container, scope: .shared, key: key, factory)
//    }
//    internal let registration: Registration<T>
//}
//
...
//    internal let factory: TypedFactory<T>
//    internal let scope: Scope?
//    init(_ container: SharedContainer, scope: Scope?, key: Int, _ factory: @escaping () -> T) {
//        self.id = "\(container.manager.managerID).\(T.self).\(key)"
//        self.container = container
//        self.factory = TypedFactory(factory: factory)
//        self.scope = scope
...
//    }
//
//    internal func resolve<T>(_ registration: Registration<T>) -> T {
//        fatalError()
//    }
//
...
//        let instance = factory.scope?.resolve(using: cache, id: factory.id, factory: current) ?? current.factory()
//        globalGraphResolutionDepth -= 1
//
...
//
//    @inlinable public func cached<T>(key: Int = #line, factory: @escaping () -> T) -> Factory<T> {
//        Factory(self, scope: .cached, key: key, factory)
//    }
//
//    @inlinable public func custom<T>(_ scope: Scope?, key: Int = #line, factory: @escaping () -> T) -> Factory<T> {
//        Factory(self, scope: scope, key: key, factory)
//    }
//
//    @inlinable public func graph<T>(key: Int = #line, factory: @escaping () -> T) -> Factory<T> {
//        Factory(self, scope: .graph, key: key, factory)
//    }
//
//    @inlinable public func shared<T>(key: Int = #line, factory: @escaping () -> T) -> Factory<T> {
//        Factory(self, scope: .shared, key: key, factory)
//    }
//
//    @inlinable public func shared<T>(_ factory: @autoclosure @escaping () -> T, key: Int = #line) -> Factory<T> {
//        Factory(self, scope: .shared, key: key, factory)
//    }
//
//    @inlinable public func singleton<T>(key: Int = #line, factory: @escaping () -> T) -> Factory<T> {
//        Factory(self, scope: .singleton, key: key, factory)
//    }
//
//    @inlinable public func unique<T>(key: Int = #line, factory: @escaping () -> T) -> Factory<T> {
//        Factory(self, scope: .unique, key: key, factory)
//    }
//
//    //    @inlinable public func Cached<T>(key: Int = #line, factory: @escaping () -> T) -> Factory<T> {
//    //        Factory(self, scope: .cached, key: key, factory)
