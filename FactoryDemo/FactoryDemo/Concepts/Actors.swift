...
extension Container {
    var myActor: Factory<SomeActor> { makes { SomeActor() } }
    var mainActorFuncTest: Factory<MainActorFuncTest> { makes { MainActorFuncTest() } }

}

extension Container {
    var mainActorTest: Factory<MainActorTest> { makes { MainActorTest() } }
}
